...
export default function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      console.log(
        `Tentando ${isLogin ? "login" : "cadastro"} com email: ${email}`
      );
  ...
  return (
    <div className="login-page">
      ...
      <div className="banner">
        ...
        <p>
          Gerencie suas finanças pessoais com facilidade e inteligência. O July
          ajuda você a controlar gastos, criar orçamentos, acompanhar
          investimentos e alcançar suas metas financeiras de forma simples e
          eficaz.
        </p>
      </div>
    </div>
